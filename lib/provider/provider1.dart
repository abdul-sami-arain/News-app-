...
import 'dart:convert';
import 'package:apicalling/classes/categoricalNews.dart';
...
class Provider1 extends ChangeNotifier {
 ...
 Future<List<Trendy>> trendyNews() async {
  ...
  Future<List<News>> News1(String? cat) async {
    final response = await dio.get('https://newsapi.org/v2/top-headlines?country=us&category=$cat&pageSize=10&apiKey=$apiKey');
