...
import 'package:apicalling/screens/newsPage.dart';
                            ...
                            StaggeredGridTile.count(
                              ...
                              child: GestureDetector(
                                onTap: () {
                                      Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => NewsPage(Catname: "Bussiness News", img: "assets/bussiness.jpg", name: "bussiness")),);
                                },
                                child: Type2(
                            ...
                            StaggeredGridTile.count(
                                ...
                                child: GestureDetector(
                                  onTap: (){
                                      Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => NewsPage(Catname: "Health News", img: "assets/health1.jpg", name: "health")),);
                                  },
                                  child: Type2(
                            ...
                            StaggeredGridTile.count(
                              ...
                              child: GestureDetector(
                                 onTap: (){
                                      Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => NewsPage(Catname: "Science News", img: "assets/sci.jpg", name: "science")),);
                                  },
                                child: Type2(
                            ...
                            StaggeredGridTile.count(
                                ...
                                child: GestureDetector(
                                   onTap: (){
                                      Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => NewsPage(Catname: "Technology News", img: "assets/tech.jpg", name: "technology")),);
                                  },
                                  child: Type2(
